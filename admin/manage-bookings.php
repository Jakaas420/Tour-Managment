...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->city);?></a></td>
								<td><?php echo htmlentities($result->postlcode);?></td>
								<td><?php echo htmlentities($result->number);?></a></td>
								<td><?php echo htmlentities($result->email);?></a></td>
								<td><?php echo htmlentities($result->destination);?></a></td>
								<td><?php echo htmlentities($result->arrivaldate);?></a></td>
								<td><?php echo htmlentities($result->departuredate);?></a></td>
								<td><?php 
								// if($result->status==0)
{
// echo "Pending";
