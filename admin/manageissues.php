				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Issues</h2>
						...
						<tbody>
<?php $sql = "SELECT tblissues.id as id,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.Emailld as email,tblissues.Issue as issue,tblissues.Description as Description,tblissues.PostingDate as PostingDate from tblissues join tblusers on tblusers.Emailld=tblissues.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
